...
exports.requestAddListMemberWithGroups = undefined;
...
const requestAddListMemberWithGroups = exports.requestAddListMemberWithGroups = () => {
  ...
  for (let i = 0; i < subberEmails.length; i++) {
    ...
    };(0, _request2.default)(postMemberWithGroupsSettings, addListMemberWithGroups);
  }
};
